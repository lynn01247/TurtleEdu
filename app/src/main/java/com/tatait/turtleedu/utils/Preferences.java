...
public class Preferences {
    ...
    private static final String DOWN_LOAD_DATA = "down_load_data";
    private static final String USER_NAME = "user_name";
    private static final String UID = "uid";
    private static final String TOKEN = "token";
    private static final String QUEUE_LIST = "queue_list";
    private static final String IS_NEVER_TIP_SCREEN = "is_never_tip_screen";
    ...
    private static final String HISTORY_COMMAND = "history_command";
    ...
    public static String getInputCommand() {
        return getString(INPUT_COMMAND, "");
    }

    public static void saveInputCommand(String inputCommand) {
        saveString(INPUT_COMMAND, inputCommand);
    }

    public static String getHistoryCommand() {
        return getString(HISTORY_COMMAND, "");
    }

    public static void saveHistoryCommand(String historryCommand) {
        saveString(HISTORY_COMMAND, historryCommand);
    }

    public static boolean isNeverTipScreen() {
        return getBoolean(IS_NEVER_TIP_SCREEN, false);
    }

    public static void saveNeverTipScreen(boolean yes) {
        saveBoolean(IS_NEVER_TIP_SCREEN, yes);
    }

    public static boolean isDownLoadData() {
        return getBoolean(DOWN_LOAD_DATA, false);
    }

    public static void saveIsDownLoadData(boolean isDownLoadData) {
        saveBoolean(DOWN_LOAD_DATA, isDownLoadData);
    }
